...
scripts/
  ...
  check-capture-fixtures.js  # Node.js golden-transcript gate for the decision-capture routine; parses fixtures/decision-capture/ transcripts and expected decision files, exits non-zero on mismatch
fixtures/
