...
- **Status frontmatter is written only by the ai-lore-build-waves orchestrator**, never by task sub-agents. Workers return structured data; the orchestrator updates files.
